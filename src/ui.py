...
class NCRAppUI:
    ...
    def render_header(self):
        ...
        Artık semantik (skorlama) filtrelemesiyle Kaba ve İnce işlerin iç içe girdiği durumlarda en doğru kararı veriyor!
        """)
    ...
    def render_filters_and_results(self, df, aciklama_kolonu, belirsizler):
        ...
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            # Excel'e yazarken de index'i (Kayıt No) ekle
